...
exclude_subs <- c("sub-11", "sub-29")

df <- tribble(
~sub,    ~ecc,  ~bars1,  ~bars2,  ~funcloc, ~max_motion,
...
- FSL 5.0.9). On average, the maximum movement was `r motion$mean_motion` ±
`r motion$sd_motion` mm.
